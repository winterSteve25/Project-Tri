...
namespace Terrain
{
    ...
    {
        [SerializeField] private GameObject groundLayerPrefab;
        [SerializeField] private GameObject obstaclesLayerPrefab;
        ...
        public void Awake()
        {
            var ground = Instantiate(groundLayerPrefab, transform);
            var obstacle = Instantiate(obstaclesLayerPrefab, transform);
            GroundLayer = ground.GetComponent<Tilemap>();
            ObstacleLayer = obstacle.GetComponent<Tilemap>();
        }
